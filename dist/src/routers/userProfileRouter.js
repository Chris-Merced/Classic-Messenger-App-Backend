...
const userProfileController = __importStar(require("../controllers/userProfileController"));
...
userProfileRouter.post('/profilePicture', multer_1.default.single('ProfilePicture'), userProfileController.changeProfilePicture);
